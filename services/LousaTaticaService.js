...
import { LousaTatica } from "../models/LousaTaticaModel.js";
import { Modalidade } from "../models/ModalidadeModel.js";

class LousaTaticaService extends BaseService {
  constructor() {
    super(LousaTatica);
  }
  ...
  async getFilteredLousas(userType, clubeId, modalidadeId, nome) {
  ...
  async duplicar(id, usuario) {
    ...
    if (!original) {
      throw new Error("Lousa tática não encontrada.");
    }
...
export default LousaTaticaService;